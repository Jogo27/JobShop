...
SRCS = main.c job.c ressource.c prob.c plan.c random.c greedy.c local.c population.c ngenetic.c square_matrice.c
OBJS = $(SRCS:.c=.o)
...
ressource.o: ressource.h main.h job.h square_matrice.h
...
square_matrice.o: main.h square_matrice.h
